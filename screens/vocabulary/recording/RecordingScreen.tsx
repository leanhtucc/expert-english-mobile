...
export const RecordingScreen: React.FC<RecordingScreenProps> = memo(
  ({ questions, route, onComplete, onBack, onClose, progress: externalProgress, lessonId }) => {
    const insets = useSafeAreaInsets();
    const safeQuestions = questions || route?.params?.questions || [];
    const safeLessonId = lessonId || route?.params?.lessonId;
    const {
      state,
      currentQuestion,
      currentIndex,
      ...
      handleNext,
      micLevel,
    } = useRecording({ questions: safeQuestions, onComplete, lessonId: safeLessonId });
...
RecordingScreen.displayName = 'RecordingScreen';
